...
## 🚀 Universal One-Command Quick Start (Select Your OS)

### 🪟 Windows (PowerShell / Command Prompt):
```powershell
git clone https://github.com/Zcross091/Public-SMP.git; cd Public-SMP; python run.py
```

### 🐧 Linux (Ubuntu / Debian / Oracle Cloud / Fedora / Arch):
```bash
git clone https://github.com/Zcross091/Public-SMP.git && cd Public-SMP && python3 run.py
```
...
### 📱 Android (Termux):
```bash
pkg update -y && pkg install -y openjdk-21 python git curl && git clone https://github.com/Zcross091/Public-SMP.git && cd Public-SMP && python run.py
```

---

### What `run.py` Does Automatically:
1. **Detects Environment**: Identifies OS (Windows, Linux distros, macOS, Android Termux), CPU architecture, system RAM, and free disk space.
...
6. **Deploys Minecraft Server**: Creates `./minecraft/`, populates `.env` and `docker-compose.yml`, and starts the container.
